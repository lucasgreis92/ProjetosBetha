...
//                                    }
                    ...
                    controller: function ($scope, $attrs, $element, WSService, $state) {
                        ...
                        // custom code (Xinguara)
                        var promise = WSService.getProdutosSantaGula();
                        promise.then(function (value) {
                            $scope.produtos = value;
                        });

                        $scope.addItem = function (produto, tab) {
                            console.log('addItem home');
                            $state.go('addproduto', {produto: produto, tab: tab});
                        }
                    }
                };
